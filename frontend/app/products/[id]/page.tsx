...
export default function ProductDetailPage() {
  // Use useParams hook instead of props - more reliable in production
  ...
  useEffect(() => {
    ...
    const preloadImages = [];
    if (selectedImage > 0) {
      preloadImages.push(product.images[selectedImage - 1]);
    }
    ...
    <Layout>
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            {/* Main Image */}
            <div className="aspect-square bg-gradient-to-br from-neutral-100 to-neutral-200 rounded-2xl overflow-hidden relative">
              {product.images && Array.isArray(product.images) && product.images.length > 0 ? (
                <img
                  src={getImageUrl(product.images[selectedImage] || product.images[0], 'detail')}
                  alt={product.name}
            ...
            {/* Thumbnail Images - Display ALL images */}
              ...
              <div className="grid grid-cols-4 gap-3">
                {product.images.map((image, index) => (
                  <button
                    ...
                    className={`aspect-square bg-gradient-to-br from-neutral-100 to-neutral-200 rounded-xl overflow-hidden border-2 transition-all ${
                  ...
                  >
                    <img 
                      ...
                      onError={(e) => {
                        ...
                        if (parent) {
                          const placeholder = document.createElement('div');
                          placeholder.className = 'w-full h-full flex items-center justify-center text-neutral-400';
                          placeholder.innerHTML = '📦';
                          parent.appendChild(placeholder);
                        }
                      }}
